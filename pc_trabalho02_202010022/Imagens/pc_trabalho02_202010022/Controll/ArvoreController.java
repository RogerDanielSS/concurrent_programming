...
public class ArvoreController implements Initializable {
   ...
   * ***************************************************************
   * Sub rotina: Jose
   * Funcao: Cria 3 novas threads e atualiza o contador de idade (jose) e de tempo
   * do da arvore genealogica
   * Parametros: void
   * Retorno: void
   ****************************************************************/
    ...
    public void run() {
      for (idade = 0; idade < 90; idade++) { // Inicio do laco while responsavel pela contagem do tempo
        ...
        if (idade == 22) { // verifica a idade certa de criar uma nova thread
          // instancia e inicia uma nova thread
   ...
   * ***************************************************************
   * Sub rotina: Pedro
   * Funcao: Cria 1 nova threads e atualiza o contador de idade (Pedro) na arvore
   * genealogica
   * Parametros: void
   * Retorno: void
   ****************************************************************/
  ...
  /****************************************************************
   * Sub rotina: Pedro Jr
   * Funcao: Cria 1 nova threads e atualiza o contador de idade (Pedro Jr) na
   * arvore
   * genealogica
   * Parametros: void
   * Retorno: void
   ...
   * Funcao: atualiza o contador de idade (Pedro Neto) na arvore
   * genealogica
   * Parametros: void
   * Retorno: void
   ****************************************************************/
  class PedroNeto extends Thread { // Inicio da classe Pedro Neto
    ...
    public void run() {
      ...
      Platform.runLater(() -> { // Inicio do metodo runLater -> Ordena a execucao do fxml para que nao ocorra
                                // excecoes
        idade_PedroNeto_TextField_out.setText("Morto aos 12"); // Informa que Pedro Neto morreu no local onde era
                                                               // impresso
                                                               // a sua idade
  ...
  /****************************************************************
   * Sub rotina: Tiago Jr
   * Funcao: atualiza o contador de idade (Tiago Jr) na arvore
   * genealogica
   * Parametros: void
   * Retorno: void
   ****************************************************************/
